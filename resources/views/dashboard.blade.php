...
<head>
    ...
    gap: 1.25rem;
        ...
        .upload-title { font-size: 0.95rem; font-weight: 600; margin-bottom: 0.25rem; }
        .upload-sub { font-size: 0.8rem; color: var(--text3); }
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item active">
                <span class="nav-icon">🗂️</span> الملفات والدوسيرات
            </div>
            <div class="nav-item">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-num">
                                            {{ number_format((float) $d->montant_initial, 2, '.', ' ') }} <span style="color:var(--text3);font-size:0.7rem">دره</span>
                                        </td>
                                        <td>
                                            @if($d->calcul)
                                            ...
                                            <div class="actions-row">
                                                <form method="post" action="{{ route('calculate', $d) }}">
                                                    ...
                                                    <div class="calc-inline">
                                                        ...
                                                        <input type="number" name="expertise" step="0.01" min="0" placeholder="خبرة" value="{{ old('expertise', $d->expertise) }}">
