/**
 * Même logique que App\Services\CalculService (montant pour الرسم + total).
 */
(function (global) {
    'use strict';
    ...
    function rasmQadai(montant) {
        ...
        if (m <= 5000) {
            return round2(m * 0.04);
        }
        if (m <= 20000) {
            return round2(m * 0.025);
        }
    ...
    function buildBreakdown(state) {
        ...
        var janaza =
            type === 'wafaya_irad_omri' || type === 'wafaya_ras_mal'
